...
$temp->add($setting);
	...
	$setting = new admin_setting_configtextarea($name, $title,get_string('sitemnuitemsdesc','theme_mb2mcl'),'dashboard,frontpage,calendar,badges,courses');
	$temp->add($setting);
...
$setting = new admin_setting_configmb2start('theme_mb2mcl/startusability', get_string('usability','theme_mb2mcl'));
$temp->add($setting);
...
$setting = new admin_setting_configmb2end('theme_mb2mcl/endusability');
$temp->add($setting);
