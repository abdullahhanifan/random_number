...
$string['allowblockstodock'] = 'Izinkan blok untuk menggunakan dok';
...
$string['configallowguestmymoodle'] = 'Jika diaktifkan tamu dapat mengakses Dasbor, jika tidak tamu dialihkan ke laman depan situs';
...
$string['configallusersaresitestudents'] = 'Untuk aktivitas di halaman depan situs, haruskah SEMUA pengguna dianggap sebagai siswa? Jika Anda menjawab "Ya", maka akun pengguna yang dikonfirmasi akan diizinkan untuk berpartisipasi sebagai siswa dalam aktivitas tersebut. Jika Anda menjawab "Tidak", maka hanya pengguna yang sudah menjadi peserta dalam setidaknya satu kursus yang dapat mengambil bagian dalam aktivitas halaman depan tersebut. Hanya admin dan pengajar yang ditugaskan khusus yang dapat bertindak sebagai pengajar untuk aktivitas halaman depan ini.';
...
$string['configcookiesecure'] = 'Jika server hanya menerima koneksi https, disarankan untuk mengaktifkan pengiriman kuki aman. Jika diaktifkan, pastikan peladen web tidak menerima http:// atau mengatur pengalihan permanen ke https:// alamat dan mengirim header HSTS secara ideal. Ketika alamat <em> wwwroot </em> tidak dimulai dengan https:// setelan ini diabaikan.';
...
$string['configcustomusermenuitems'] = 'Anda dapat mengkonfigurasi konten menu pengguna (dengan pengecualian tautan log keluar, yang ditambahkan secara otomatis). Setiap baris dipisahkan oleh karakter pipa dan terdiri dari 1) string dalam bentuk "langstringname, componentname" atau sebagai teks biasa, 2) URL, dan 3) ikon baik sebagai ikon piksel (di folder pix dengan struktur [subfolder]/[nama ikon], misalnya i/publish) atau sebagai URL. Pemisah dapat digunakan dengan menambahkan satu baris dari satu atau lebih # karakter jika diinginkan.';
...
$string['configdebugdisplay'] = 'Setel ke aktif, pelaporan kesalahan akan menuju ke halaman HTML. Ini praktis, tetapi merusak header XHTML, JS, kuki, dan HTTP secara umum. Jika disetel ke nonaktif, ini akan mengirim keluaran ke log peladen Anda, memungkinkan awakutu yang lebih baik. Setelan PHP error_log mengontrol ke mana log ini masuk.';
$string['configdebugpageinfo'] = 'Aktifkan bila Anda menghendaki informasi halaman ikut dicetak pada bagian footer.';
$string['configdebugvalidators'] = 'Aktifkan jika Anda ingin memiliki tautan ke peladen validator eksternal di footer halaman. Anda mungkin perlu membuat pengguna baru dengan nama pengguna <em> w3cvalidator </em>, dan mengaktifkan akses tamu. Perubahan ini memungkinkan akses tidak sah ke peladen, jangan aktifkan di situs produksi!';
...
$string['configdndallowtextandlinks'] = 'Mengaktifkan atau menonaktifkan menyeret dan melepaskan teks dan tautan ke halaman kursus, di samping menyeret dan melepaskan berkas. Perhatikan bahwa menyeret teks ke Firefox atau di antara peladen yang berbeda tidak dapat diandalkan dan mungkin mengakibatkan tidak ada data yang diunggah, atau teks rusak yang diunggah.';
...
$string['configforcelogin'] = 'Biasanya, halaman depan situs dan daftar perlajaran (tetapi bukan kursus) dapat dibaca oleh orang-orang tanpa masuk ke situs. Jika Anda ingin memaksa orang untuk masuk sebelum mereka melakukan APA SAJA di situs, maka Anda harus mengaktifkan setelan ini.';
...
$string['configfrontpageloggedin'] = 'Item yang dipilih di atas akan ditampilkan di halaman depan situs ketika pengguna masuk.';
...
$string['configmypagelocked'] = 'Setelan ini mencegah halaman default diedit oleh non-admin';
...
$string['configproxyhost'] = 'Jika <b> peladen </b> ini perlu menggunakan proksi komputer (mis. Firewall) untuk mengakses Internet, maka berikan nama host proksi di sini. Kalau tidak biarkan kosong.';
...
$string['configrequestcategoryselection'] = 'Izinkan memilih kategori ketika melakukan permintaan kursus.';
...
$string['configtimezone'] = 'Ini adalah zona waktu bawaan untuk menampilkan tanggal - setiap pengguna dapat mengabaikan pengaturan ini di profil mereka. Tugas Cron dan pengaturan peladen lainnya ditentukan dalam zona waktu ini. Anda harus mengubah pengaturan jika ditampilkan sebagai "Zona waktu tidak valid"';
...
$string['frontpagebackup'] = 'Pencadangan Halaman Depan';
...
$string['lockoutemailbody'] = 'Akun Anda dengan nama pengguna {$a->username} di peladen \'{$a->sitename}\' dikunci setelah beberapa upaya login tidak valid.
...
$string['profilefieldmaxlength'] = 'Panjang maksimum';
...
$string['registermoodleorg'] = 'Kapan Anda mendaftarkan situs Anda';
...
$string['replacefrontsearch'] = 'Digunakan untuk pencarian kursus halaman depan';
...
$string['updateautocheck'] = 'Cek otomatis untuk pembaruan yag tersedia';
