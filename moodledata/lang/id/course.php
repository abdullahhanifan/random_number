...
$string['coursecontentnotification_help'] = 'Anda dapat mengirim pemberitahuan kepada pengguna kursus tentang sumber daya atau aktivitas baru atau yang diperbarui. Harap perhatikan bahwa pemberitahuan akan dikirim hanya jika sumber daya atau aktivitas baru terlihat.';
...
$string['downloadcontent'] = 'Sertakan dalam unduhan kursus (jika fitur itu diaktifkan)';
$string['downloadcontent_help'] = 'Setelan ini menentukan apakah aktivitas ini dapat diunduh ketika unduhan konten kursus diaktifkan untuk kursus ini';
