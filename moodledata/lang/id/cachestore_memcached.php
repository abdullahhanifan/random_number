...
$string['bufferwrites_help'] = 'Mengaktifkan atau menonaktifkan buffer I/O. Mengaktifkan buffer I/O menyebabkan perintah penyimpanan menjadi "buffer" alih-alih dikirim. Setiap tindakan yang mengambil data menyebabkan buffer ini dikirim ke koneksi jarak jauh. Menghentikan koneksi atau menutup koneksi juga akan menyebabkan data buffer didorong ke koneksi jarak jauh.';
