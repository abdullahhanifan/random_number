...
class __Mustache_92667c7c878c4f47c03b1e8d4a00fe91 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section3e7d77fd98d69879ad892fe562239117($context, $indent, $value);
        $buffer .= $indent . '        </tbody>
';
        $buffer .= $indent . '    </table>
';
...
';
        ...
        $buffer .= $this->section914d5c126be7872f7309dcbb9d1df73e($context, $indent, $value);
...
';
    ...
    private function section8aef8d57bed0f152419dbf9cc1dab670(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section44aecfe1520516ec9a3a749adc052636(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section8aef8d57bed0f152419dbf9cc1dab670($context, $indent, $value);
                $buffer .= $indent . '                                    </ul>
';
...
';
    ...
    private function sectionEa665e69ea54f77dfccf00777d4d8bbf(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                // 'hasevents' section
                $value = $context->find('hasevents');
                $buffer .= $this->section44aecfe1520516ec9a3a749adc052636($context, $indent, $value);
                $buffer .= $indent . '                        </div>
';
...
';
    ...
    private function section3e7d77fd98d69879ad892fe562239117(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionEa665e69ea54f77dfccf00777d4d8bbf($context, $indent, $value);
                // 'postpadding' section
...
';
    ...
    private function section914d5c126be7872f7309dcbb9d1df73e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '        var target = root.find(CalendarSelectors.eventType[data.type]);
';
                $buffer .= $indent . '
';
